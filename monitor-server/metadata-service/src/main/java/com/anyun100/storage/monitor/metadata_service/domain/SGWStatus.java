...
@Table(name = "sgw_status")
@Entity
public class SGWStatus implements Comparable<SGWStatus>{
    /**
	 * 
	 */
	...
	public Long getSgwId() {
		return sgwId;
	}


	public void setSgwId(Long sgwId) {
		this.sgwId = sgwId;
	}


	public int compareTo(SGWStatus other) {
