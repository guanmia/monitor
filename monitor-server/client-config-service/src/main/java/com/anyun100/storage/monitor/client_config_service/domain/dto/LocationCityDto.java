...
public class LocationCityDto implements Serializable {
	...
	public LocationCityDto(String location_id, String location, Long level, String parent_id, List<LocationDto> children) {
